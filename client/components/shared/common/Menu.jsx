...
const Menu = ({ user }) => {
  ...
  return (
    <div className="md:max-w-20 max-w-[100vw] w-full md:max-h-screen max-h-[8vh] md:order-1 order-2 bg-secondary">
      <div className="flex h-full md:flex-col flex-row justify-center md:justify-between items-center py-5 px-2">
        ...
        <div className="md:flex md:flex-col hidden gap-3 items-center justify-center">
          <ThemeButton />
          <div
            onClick={() => setActiveMenu(MenuConst.PROFILE)}
            className={`${activeMenu === MenuConst.PROFILE ? "border rounded-full border-slate-800" : ""} `}
          >
